...
/* Added by Tim Massingham, tim.massingham@ebi.ac.uk
 * 6 March 2005
 */
#include <float.h>
...
double fminbr(a,b,f,tol,neval)		/* An estimate to the min location*/
...
int * neval;				/* Counter for number of evaluations */
{
  ...
  for(;;)		/* Main iteration loop	*/
  {
    ...
    {				/* and reduce the enveloping range	*/
      ...
      register double ft = (*f)(t);  *neval = *neval + 1;
      if( ft <= fx )
